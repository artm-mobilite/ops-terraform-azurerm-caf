...
virtual_machines = {
  example_vm1 = {
    ...
    virtual_machine_extensions = {
      linux_diagnostic = {
        ladcfg_file_path               = "examples/compute/virtual_machine/216-vm-linux_diagnostic_extensions/diagnostics/ladcfg.json"
        filelogs_file_path             = "examples/compute/virtual_machine/216-vm-linux_diagnostic_extensions/diagnostics/filelogs.json"
