...
resource "azurerm_virtual_network_gateway" "vngw" {
  ...
  dynamic "vpn_client_configuration" {
    ...
    content {
      ...
      aad_audience = try(vpn_client_configuration.value.aad_audience, null) != null ? vpn_client_configuration.value.aad_audience : try(var.remote_objects.azuread_applications[try(vpn_client_configuration.value.lz_key, var.client_config.landingzone_key)].sign_in_audience, null)
      aad_issuer   = try(vpn_client_configuration.value.aad_issuer, null) != null ? vpn_client_configuration.value.aad_issuer : try(var.remote_objects.azuread_applications[try(vpn_client_configuration.value.lz_key, var.client_config.landingzone_key)].application_id, null)
      aad_tenant   = try(vpn_client_configuration.value.aad_tenant, null) != null ? vpn_client_configuration.value.aad_tenant : try(var.remote_objects.azuread_applications[try(vpn_client_configuration.value.lz_key, var.client_config.landingzone_key)].tenant_id, null)
